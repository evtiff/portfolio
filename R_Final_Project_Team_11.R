  ...
  navbarPage(
    ...
    tabPanel(
      ...
      dashboardPage(
        ...
        dashboardSidebar(
          titlePanel("Job You Are Interested In"),
          selectInput(
            inputId = "jobtitle",
          ...
          titlePanel("Download PDF Report"),
    ...
    tabPanel("Skill Matching",
             dashboardPage(
               dashboardHeader(titleWidth = 0),
               dashboardSidebar(
                 titlePanel("Resume Analysis"),
                 fileInput("doc",
    ...
    tabPanel("Prediction",
             dashboardPage(
               ...
               dashboardSidebar(titlePanel(""),
                 radioButtons(inputId = "companySize", "Company Size:",
                                             c("Small" = "Small",
                                               "Medium" = "Medium",
                                               "Large" = "Large")),
                 numericInput("pwWAGE", "Wage:", 70000, min = 5000, max = 500000),
                 selectInput( inputId = "pwSkillLevel:", label = "Skill Level",
               ...
               dashboardBody(
                 fluidRow(
                   # The below can be deleted when all codes is finalized
                   valueBoxOutput("companySize", width = 4),
                   valueBoxOutput("pwWAGE", width = 4),
                   valueBoxOutput("pwSkillLevel", width = 4),
                   valueBoxOutput("region", width = 4),
